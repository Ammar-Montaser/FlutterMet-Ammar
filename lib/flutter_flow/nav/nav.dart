...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/myCollectionScreen',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'MyCollectionScreen')
              : const MyCollectionScreenWidget(),
        ),
        FFRoute(
          name: 'DepartmentsHighlightsScreen',
          path: '/departmentsHighlightsScreen',
          builder: (context, params) => DepartmentsHighlightsScreenWidget(
